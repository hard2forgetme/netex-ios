...
Netex iOS is an unofficial iOS companion to Netex by Mr.doob. It keeps Netex's MIT license and attribution intact while living in a separate iOS-focused repository.
...
Netex iOS is MIT licensed. Keep the root `LICENSE` file with forks, builds, and pull requests.
